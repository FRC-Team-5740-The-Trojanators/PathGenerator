...
public class Main
{
    ...
    private static final String FLAGS = "[-g]";
    private static final String USAGE =
        "Usage: wayfinder text | gui " + FLAGS + " <waypoints file path> <trajectory output file>";
    ...
    public static void main(String args[])
    {
        try 
        {
            ...
            // Operation.
            if (!(   operation.equalsIgnoreCase("text") || operation.equalsIgnoreCase("gui"))) 
            {
                throw new Exception();
            }
        }
